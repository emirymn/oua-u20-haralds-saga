...
{
    [Header("Item Change")]
    [SerializeField] public Animator ani, attackAni;
    ...
    private void Update()
    {
        ...
        {
            //    attackAni = Items[ItemIdInt].gameObject.GetComponent<Animator>();

            Debug.Log("Solclick");
            ani.SetBool("Hit", true);

            //  Debug.Log(attackAni.GetCurrentAnimatorStateInfo(0));
